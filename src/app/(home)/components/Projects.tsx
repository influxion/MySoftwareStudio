...
import MatrixProject from './MatrixProject'

export default function Projects({ projects }: { projects: Project[] }) {
  return (
    <div className="max-w-[1440px] m-auto h-full px-4 md:py-24 py-48">
      <RevealDiv>
        <div className="flex flex-col md:gap-24 gap-12">
          {projects.map((project, i) => (
            <div
              key={project._id}
              className={`${i % 2 === 0 ? '' : 'ml-auto'} w-2/3`}
            >
              <MatrixProject
                width={1000}
                height={600}
              ...
              >
                <div className="absolute top-0 w-[60%] p-4 select-none backdrop-blur-sm rounded-lg">
                  ...
                  <p className="w-full text-white/50">
                    ...
                    totam necessitatibus fuga beatae, laborum voluptates.
                    Molestiae, rem?
                  </p>
                </div>
